...
void printScaledData(const SensorData *sd, const offset_values *ov)
{
    Serial.print(F("axyz/temp/gxyz Scaled Data:\t"));
    Serial.print(float(sd->accelX + ov->ax_offset)/16384); Serial.print("   ");
    Serial.print(float(sd->accelY + ov->ay_offset)/16384); Serial.print("   ");
    Serial.print(float(sd->accelZ + ov->az_offset)/16384); Serial.print("   ");
    Serial.print(float(sd->temperature/340) +36.53); Serial.print("   ");
    Serial.print(float(sd->gyroX + ov->gx_offset)/131); Serial.print("   ");
    Serial.print(float(sd->gyroY + ov->gy_offset)/131); Serial.print("   ");
    Serial.println(float(sd->gyroZ + ov->gz_offset)/131); 
    Serial.println(" ");
}

void printUnscaledData(const SensorData *sd, const offset_values *ov)
{
    Serial.print(F("axyz/temp/gxyz Unscaled Data:\t"));
    Serial.print(float(sd->accelX + ov->ax_offset)); Serial.print("   ");
    Serial.print(float(sd->accelY + ov->ay_offset)); Serial.print("   ");
    Serial.print(float(sd->accelZ + ov->az_offset)); Serial.print("   ");
    Serial.print(float(sd->temperature/340) +36.53); Serial.print("   ");
    Serial.print(float(sd->gyroX + ov->gx_offset)); Serial.print("   ");
    Serial.print(float(sd->gyroY + ov->gy_offset)); Serial.print("   ");
    Serial.println(float(sd->gyroZ + ov->gz_offset)); 
    Serial.println(" ");
}
